        ...
        <div class="container">
            <div class="hit-slider js-hit-slider">
                <div class="title-block">
                    <div class="title-block__title"><span><?pll_e('title_news-stocks')?></span><a class="title-block__link" href="<?=prepareLinkPll('/news/')?>"><?pll_e('link_all-news')?></a></div>
                ...
                <div class="hit-slider__slider swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <?foreach( $items as $item ):?>
                            ...
                            <a class="not-link hit-slider__slide swiper-slide card card_news<?/*card_stock*/?>" href="<?=$item['link']?>">
                                <?if($item['thumbnail']):?>
                                    <div class="card__image">
                                        <img class="lazy swiper-lazy" data-src="<?=$item['thumbnail']['src']?>" src="<?=THEME_URL?>/assets/images/pattern.png"/>
                                    </div>
                                <?endif;?>
                                <div class="card__box">
                                    <?if( $item['tax'][0] ):?><span class="card__type"><?=$item['tax'][0]['name']?></span><?endif;?>
                                    <h4 class="card__title"><?=$item['name']?></h4>
                                    <?if( $item['preview'] && false ):?><p class="card__text"><?=$item['preview']?></p><?endif;?>
                                    <span class="card__date"><?=date_i18n( 'j F Y', strtotime($item['modify']))?></span>
                                </div>
                            </a>
