...
class WSTDBreadcrumbs {
    ...
    protected $templates = [ //s - section section_breadcrumbs d - section__wrapper section__wrapper_breadcrumbs
        "container" => "<section class='section section_breadcrumbs'><div class='section__wrapper section__wrapper_breadcrumbs'><div class='breadcrumbs'>#content#</div></div></section>",
//        "container" => "<section class=''><div class=''><div class='breadcrumbs'>#content#</div></div></section>",
        "link" => "<a class='link link_breadcrumb' href='#url#' title='#title#'>#title#</a>",
        "active_item" => "<span class='current'>#title#</span>"
