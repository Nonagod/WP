        ...
        <div class="container">
            <div class="hit-slider js-hit-slider">
                <div class="title-block">
                    <div class="title-block__title"><span><?pll_e('title_services')?></span><a class="title-block__link" href="<?=prepareLinkPll('/services/')?>"><?pll_e('link_all-services')?></a></div>
                ...
                <div class="hit-slider__slider swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <?foreach( $items as $item ):?>
                            ...
                            <div class="hit-slider__slide swiper-slide card card_services">
                                <div class="card__image">
                                    <img class="swiper-lazy" data-src="<?=$item['thumbnail']['src']?>" src="<?=THEME_URL?>/assets/images/pattern.png"/>
                                </div>
                                <div class="card__box">
                                    <h4 class="card__title"><?=$item['name']?></h4>
                                    <?if( $item['preview'] ):?><p class="card__text"><?=$item['preview']?></p><?endif;?>
                                    <a class="not-link button button_grey button_mini card__button" href="<?=$item['link']?>"><?pll_e('more');?></a>
                                </div>
                            </div>
